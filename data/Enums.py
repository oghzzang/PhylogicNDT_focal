...
CSIZE = [249250621, 243199373, 198022430, 191154276, 180915260, 171115067, 159138663, 146364022, 141213431,
         ...
         63025520, 48129895, 51304566, 156040895, 57227415, 156500000]

chrom_dict = {'chr' + str(c): s for c, s in zip(list(range(1, 23)) + ['X', 'Y'] + ['25'], CSIZE)}
...
CENT_LOOKUP = {1: 125000000, 2: 93300000, 3: 91000000, 4: 50400000, 5: 48400000,
               ...
               22: 14700000, 23: 60600000, 24: 12500000, 25: 155000000}

# chr1, q22 region (chr1:155000001, 156500000)
